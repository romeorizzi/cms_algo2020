...
La prima riga del file \verb'input.txt' contiene tre numeri interi e positivi: $m$, $n$, e $t$, come nell’ordine, dove $t\in \{0,1\}$ precisa il tipo di output desiderato.
