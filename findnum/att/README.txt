...
/usr/bin/g++ -DEVAL -std=gnu++11 -O2 -pipe -static -s -o findnum findnum.cpp
...
g++ -std=gnu++11 -O2 -pipe -static -s -o findnum findnum.cpp
...
romeo@romeo-HP-ProBook-450-G4:~/2020/findnum/att$ ./findnum < input1.txt
...
romeo@romeo-HP-ProBook-450-G4:~/2020/findnum/att$ ./findnum < input2.txt
